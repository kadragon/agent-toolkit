...
- *"#7's cut rests on an unverified assumption."* The premise was correct — the original scoring
  did assume it — but the conclusion survives verification. `task-review/SKILL.md:90,162,281`
  already distinguish reviewed-empty from skipped and surface both. Cut stands, now on evidence.
