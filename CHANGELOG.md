...
- [done] harness-curate audits the auto-memory store, promotes repo facts to docs/ (dev v4.1.0) (2026-08-05) → dev/skills/harness-curate/references/signal-taxonomy.md
