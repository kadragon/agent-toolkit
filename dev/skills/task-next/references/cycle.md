...
and reports through its final output — a role-file agent has no tool for messaging the
orchestrator mid-run (`docs/delegation.md` → *Result handoff*); brief it never to finish silently.
Rules either way:
