...
paths, and the lint/test command, and told to verify against those criteria rather than impressions
and to change nothing. What must never be dropped is the independence, not the role name: the agent
