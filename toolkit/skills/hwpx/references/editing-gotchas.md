...
## 7. Empty-cell self-closing run → full run pattern
...
## 8. `<hp:t>` regex — `<hp:t[^>]*>` over-matching trap
...
## 9. Targeting empty cells via paraPrIDRef
...
## 10. Single empty paragraph → multiple paragraph replacement
